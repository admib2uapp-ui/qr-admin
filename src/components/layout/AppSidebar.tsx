        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={pathname === '/helpdesk'} tooltip="Helpdesk">
                  <Link href="/helpdesk">
            ...
            <SidebarGroup>
              ...
              <SidebarGroupContent>
                <SidebarMenu>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild isActive={pathname === '/admin/partners'} tooltip="Partners">
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild isActive={pathname === '/admin/soundbox-report'} tooltip="Soundbox Report">
                      <Link href="/admin/soundbox-report">
                        <Volume2 className="h-4 w-4" />
                        <span>Soundbox Report</span>
                      </Link>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                </SidebarMenu>
